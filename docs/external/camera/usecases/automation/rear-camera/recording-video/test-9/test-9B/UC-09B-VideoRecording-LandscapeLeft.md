# 🎥 Use Case: Video Recording - Landscape Left Orientation  

## 🎯 Objective  
Verify that video recording works correctly in **landscape left orientation** when the device orientation is unlocked.  
...
- **Excluded:**  
  - Other orientations (portrait, landscape right).  
...
## ✋ Interaction Rules  
- **Record Button**  
  - Tap → start recording in landscape left orientation.  
- **Zoom Control**  
...
3. Hold device in **landscape left orientation**.  
4. Tap the **Record button** to start recording.  
   - Verify preview is displayed in landscape left.  
   - Verify timer starts counting.  
5. Adjust zoom during recording.  
   - Verify preview remains smooth in landscape left.  

### ✅ Expected Result  
- Video is recorded and saved correctly in **landscape left orientation**.  
- UI elements remain aligned in landscape left throughout recording.  

## ✅ Pass Criteria  
- Recording starts/stops successfully.  
- Preview and icons remain stable in landscape left.  
- Video playback shows correct landscape left orientation.  
