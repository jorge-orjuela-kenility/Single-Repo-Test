# 📷 Use Case: Take Photo in Landscape Right Orientation (Rear Camera)  

## 🎯 Objective  
Verify that the user can take a photo with the **rear camera** while the device is in **Landscape Right orientation**, ensuring the captured photo is aligned correctly.  
...
- **Preview**: adapts to Landscape Right orientation.  
...
3. Rotate the device to **Landscape Right orientation**.  
4. Tap the **Take Photo Button**.  
   - Verify **shutter sound** plays.  
   - Verify photo is saved in **Landscape Right orientation**.  

### ✅ Expected Result  
- Photo is saved correctly in **Landscape Right orientation**.  
