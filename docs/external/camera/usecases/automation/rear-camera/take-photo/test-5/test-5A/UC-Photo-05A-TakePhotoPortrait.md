# 📷 Use Case: Take Photo in Portrait Orientation (Rear Camera)  

## 🎯 Objective  
Verify that the user can take a photo with the **rear camera** while the device is in **Portrait orientation**, ensuring the captured photo is aligned correctly with the orientation.  
...
- **Preview**: adapts to Portrait orientation.  
...
4. Tap the **Take Photo Button**.  
   ...
   - Verify photo is saved in Portrait orientation.  

### ✅ Expected Result  
- Photo is saved correctly in **Portrait orientation**.  
- Shutter sound plays on capture.  
- No distortion or rotation issues occur.  
