# 🎥 Use Case: Record Video in Portrait Orientation with Front Camera  

## 🎯 Objective  
Validate that front camera video recording works correctly in **portrait orientation** when device orientation is not locked.  

## 🧪 Test Scope  
- **Included:**  
  - Recording video in portrait orientation.  
- **Excluded:**  
  - Landscape orientations, flash, zoom, audio, pausing/resuming.  
...
## ✋ Interaction Rules  
- **Record Button** → Tap → Start recording in portrait orientation.  
...
### ✅ Expected Result  
- Video records correctly in portrait orientation.  
- No UI glitches or crashes occur.  

## ✅ Pass Criteria  
- Recorded video is in portrait orientation.  
