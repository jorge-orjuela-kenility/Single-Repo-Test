# 🎥 Use Case: Record Video in Landscape Right Orientation with Front Camera  

## 🎯 Objective  
Validate that front camera video recording works correctly in **landscape-right orientation** when device orientation is not locked.  

## 🧪 Test Scope  
- **Included:**  
  - Recording video in landscape-right orientation.  
- **Excluded:**  
  - Portrait or landscape-left orientations, flash, zoom, audio, pausing/resuming.  
...
## ✋ Interaction Rules  
- **Record Button** → Tap → Start recording in landscape-right orientation.  

## 📸 Test Steps  
1. Launch the SDK camera and select **front camera**.  
2. Ensure device orientation lock is disabled.  
3. Rotate device to **landscape-right orientation**.  
4. Tap **Record Button** to start recording. 

### ✅ Expected Result  
- Video records correctly in landscape-right orientation.  
- No UI glitches or crashes occur.  

## ✅ Pass Criteria  
- Recorded video is in landscape-right orientation.  
